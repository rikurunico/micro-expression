...
class KNNClassifier:
    ...
    def save_model(self, filename="knn_model.joblib", label_encoder_filename="label_encoder.joblib"):
        ...
        print(f"Label encoder saved to {os.path.join(output_model_path, label_encoder_filename)}")
